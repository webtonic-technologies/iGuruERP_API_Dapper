    ...
    public class EmailService : IEmailService
    {
        ...
        public async Task<ServiceResponse<string>> SendEmailToStudents(SendEmailStudentRequest request)
        {
            ...
            { 
                ...
                { 
                    await _emailRepository.InsertEmailForStudent(request.GroupID, request.InstituteID, student.StudentID, student.EmailSubject, student.EmailBody, EmailDate, 1, request.SentBy); // Assuming SMSStatusID is 1
        ...
        public async Task<ServiceResponse<string>> SendEmailToEmployees(SendEmailEmployeeRequest request)
        {
            ...
            { 
                ...
                {
                    await _emailRepository.InsertEmailForEmployee(request.GroupID, request.InstituteID, employee.EmployeeID, employee.EmailSubject, employee.EmailBody, EmailDate, 1, request.SentBy); // Assuming SMSStatusID is 1
        ...
        private string GenerateExcelFile(List<EmailStudentReportExportResponse> data)
        {
            using (var package = new ExcelPackage())
            {
                ...
                worksheet.Cells[1, 8].Value = "Sent By";
                ...
                foreach (var item in data)
                {
                    ...
                    worksheet.Cells[row, 8].Value = item.SentBy;
        ...
        private string GenerateCsvFile(List<EmailStudentReportExportResponse> data)
        {
            ...
            csvBuilder.AppendLine("Admission Number, Student Name, Class Section, Date Time, Email Subject, Email ID, Status, Sent By");
        ...
        {
            var response = await _emailRepository.GetEmailEmployeeReportExport(request);
            ...
            return new ServiceResponse<string>(true, "Excel file generated", response.Data, 200);
        }

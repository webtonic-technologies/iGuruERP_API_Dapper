...
namespace Institute_API.Repository.Interfaces
{
    public interface IEventRepository
    {
        ...
        Task<ServiceResponse<List<EventDTO>>> GetApprovedEvents(int Institute_id, int Academic_year_id, int status ,string sortColumn, string sortDirection, int? pageSize = null, int? pageNumber = null);

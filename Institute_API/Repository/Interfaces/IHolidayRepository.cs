...
namespace Institute_API.Repository.Interfaces
{
    public interface IHolidayRepository
    {
        ...
        Task<ServiceResponse<List<HolidayDTO>>> GetApprovedHolidays(int Institute_id, int Academic_year_id, int Status,string sortColumn, string sortDirection, int? pageSize = null, int? pageNumber = null);

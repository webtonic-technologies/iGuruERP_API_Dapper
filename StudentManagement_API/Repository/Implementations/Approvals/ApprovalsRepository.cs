    ...
    public class ApprovalsRepository : IApprovalsRepository
    {
        ...
        public async Task<int> CreatePermissionSlipAsync(CreatePermissionSlipRequest request)
        {
            ...
            (
                ...
                Institute_id,
                AcademicYearCode,       -- New column for AcademicYearCode
                RequestedBy,
                PickedUpBy,
                Reason,
                RequestedDateTime
            ...
            (
                ...
                @InstituteID,
                @AcademicYearCode,  -- New parameter value
                @RequestedBy,
                @PickedUpBy,
                @Reason,
                GETDATE()
            ...
            var parameters = new
            {
                ...
                AcademicYearCode = request.AcademicYearCode, // New parameter value
        ...
        public async Task<IEnumerable<GetPermissionSlipResponse>> GetPermissionSlipAsync(GetPermissionSlipRequest request)
        {
            ...
            WHERE
              ...
              AND ps.AcademicYearCode = @AcademicYearCode  -- New filter added
            ...
            var result = await connection.QueryAsync<GetPermissionSlipResponse>(
                ...
                {
                    InstituteID = request.InstituteID,
                    AcademicYearCode = request.AcademicYearCode,  // New parameter passed
